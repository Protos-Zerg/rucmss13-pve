...
/datum/reagent/medical/oxycodone
	...
	reagent_state = LIQUID
	color = "#E01D25"
	custom_metabolism = AMOUNT_PER_TIME(15, 7 MINUTES) // Lasts 7 minutes for 15 units
...
/datum/reagent/medical/anti_toxin
	...
	overdose_critical = REAGENTS_OVERDOSE_CRITICAL
	chemclass = CHEM_CLASS_COMMON
	properties = list(PROPERTY_ANTITOXIC = 2, PROPERTY_NEPHROPEUTIC = 0.5, PROPERTY_HEPATOPEUTIC = 0.5, PROPERTY_ANTIHALLUCINOGENIC = 2)
...
/datum/reagent/medical/alkysine
	...
	overdose_critical = REAGENTS_OVERDOSE_CRITICAL
	chemclass = CHEM_CLASS_UNCOMMON
	properties = list(PROPERTY_NEUROPEUTIC = 0.5)
...
/datum/reagent/medical/imidazoline
	...
	overdose_critical = REAGENTS_OVERDOSE_CRITICAL
	chemclass = CHEM_CLASS_UNCOMMON
	properties = list(PROPERTY_OCULOPEUTIC = 0.5)
