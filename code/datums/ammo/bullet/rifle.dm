...
/datum/ammo/bullet/rifle/heap
	...
	damage = 75//big damage, doesn't actually blow up because thats stupid.
	penetration = ARMOR_PENETRATION_TIER_6
...
/datum/ammo/bullet/rifle/heavy/upp_smartgun
	name = "12.7x40 bullet"
	damage = 110 //giant fuck off bullet
	damage_falloff = 0
...
/datum/ammo/bullet/rifle/heavy/heap/sniper
	...
	damage = 300 //match-grade munitions developing better velocity from the rifle
